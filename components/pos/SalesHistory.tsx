...
import { HistoryEntry } from '@/types/pos';
...
export default function SalesHistory({ history, loading }: Props) {
    ...
    <div className="h-full overflow-y-auto px-9 pt-7 pb-10">
      ...
      {loading ? (
        <div className="flex items-center justify-center py-20">
          <span className="font-medium text-[14px] text-ink-ghost font-grotesk">Loading…</span>
        </div>
      ) : history.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-3 py-20 text-center">
          <span className="font-semibold text-[15px] text-ink-faint font-grotesk">No transactions yet</span>
          <span className="font-normal text-[13px] text-ink-ghost font-grotesk">
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-[6px]">
                ...
                {h.staff && (
                  <span className="self-start font-semibold text-[11px] tracking-[0.05em] text-red bg-red-light px-[9px] py-[3px] rounded-[7px] font-grotesk">
                    STAFF −$0.50
                  </span>
                )}
              </div>
